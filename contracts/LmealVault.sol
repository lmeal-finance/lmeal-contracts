...
interface IMasterChef {
    ...
    function pendingLmeal(uint256 _pid, address _user) external view returns (uint256);
...
// File: contracts/LmealVault.sol

pragma solidity 0.6.12;

contract LmealVault is Ownable, Pausable {
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingLmeal(0, address(this));
